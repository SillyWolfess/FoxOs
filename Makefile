objects = boot.o kernel.o port.o idtstub.o idt.o terminal.o gdt.o keyboard.o driverManager.o driver.o event.o keyEvent.o eventHandler.o eventManager.o keyboardEventHandler.o
